export type PipelineFunc<FirstArgs extends any[], LastReturn> = [(...args: FirstArgs) => LastReturn] | [(...args: FirstArgs) => any, (arg: any) => LastReturn] | [
    (...args: FirstArgs) => any,
    ...((arg: any) => any)[],
    (arg: any) => LastReturn
];
 ...
 */
export declare function usePipeline<FirstArgs extends any[], LastReturn, Fn extends PipelineFunc<FirstArgs, LastReturn>>(...funcs: Fn): (...arg: PipeInput<Fn>) => PipeOutput<Fn>;
